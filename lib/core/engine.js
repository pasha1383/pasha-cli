...
async function renderModuleFiles(srcDir, destDir, ctx, moduleNames) {
  for (const moduleName of moduleNames) {
    await renderTemplateDir(srcDir, destDir, { ...ctx, moduleName });
  }
}

module.exports = { renderTemplateDir, renderModuleFiles, renderString };
