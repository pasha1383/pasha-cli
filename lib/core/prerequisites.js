...
const INSTALL_MAP = {
  brew: {
    ...
    rustc: ['brew', 'install', 'rustup-init'],
  ...
  'apt-get': {
    ...
    php: ['sudo', 'apt-get', 'install', '-y', 'php', 'php-cli', 'php-mbstring', 'php-xml', 'php-curl'],
    composer: null,
    rustc: null,
    cargo: null,
  ...
  dnf: {
    ...
    php: ['sudo', 'dnf', 'install', '-y', 'php', 'php-cli', 'php-mbstring', 'php-xml', 'php-curl'],
    composer: null,
    rustc: ['sudo', 'dnf', 'install', '-y', 'rust', 'cargo'],
  ...
  pacman: {
    ...
    rustc: ['sudo', 'pacman', '-S', '--noconfirm', 'rust'],
