...
function resolveDependencies(flags) {
  ...
  requirements.push('tornado>=6.4.0');
  ...
  if (flags.ormTortoise) {
    ...
    devRequirements.push('aerich>=0.7.0');
  ...
  if (flags.useSwagger) {
    requirements.push('tornado-swagger>=0.2.0');
  }
  ...
  if (flags.useRateLimit) {
    requirements.push('tornado-ratelimit>=0.1.0');
  }
  ...
  if (flags.useTests) {
    ...
    devRequirements.push('pytest-tornado>=0.8.1');
